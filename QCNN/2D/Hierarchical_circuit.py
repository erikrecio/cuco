...
def Hierarchical_structure(U, params):
...
@qml.qnode(dev_TTN)
def Hierarchical_classifier(X, params, U, embedding_type='Amplitude', cost_fn='cross_entropy'):
    embedding.data_embedding(X, embedding_type=embedding_type)
    if U == 'U_TTN':
        Hierarchical_structure(unitary.U_TTN, params)
    elif U == 'U_5':
        Hierarchical_structure(unitary.U_5, params)
    elif U == 'U_6':
        Hierarchical_structure(unitary.U_6, params)
    elif U == 'U_9':
        Hierarchical_structure(unitary.U_9, params)
    elif U == 'U_13':
        Hierarchical_structure(unitary.U_13, params)
    elif U == 'U_14':
        Hierarchical_structure(unitary.U_14, params)
    elif U == 'U_15':
        Hierarchical_structure(unitary.U_15, params)
    elif U == 'U_SO4':
        Hierarchical_structure(unitary.U_SO4, params)
    elif U == 'U_SU4':
        Hierarchical_structure(unitary.U_SU4, params)
    else:
